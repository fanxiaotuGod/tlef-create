...
router.post('/generate', authenticateToken, validateGenerateObjectives, asyncHandler(async (req, res) => {
  ...
  try {
    ...
    // Generate learning objectives using Ollama
    const generatedObjectives = await ollamaService.generateLearningObjectives(
      materials,
...
router.post('/classify', authenticateToken, validateClassifyObjectives, asyncHandler(async (req, res) => {
  ...
  try {
    ...
    // Classify learning objectives using Ollama
    const classifiedObjectives = await ollamaService.classifyLearningObjectives(text);
...
router.post('/:id/regenerate', authenticateToken, validateMongoId, asyncHandler(async (req, res) => {
  ...
  try {
    ...
    // Regenerate the single objective using Ollama
    const regeneratedText = await ollamaService.regenerateSingleObjective(
      objective.text,
      materials,
